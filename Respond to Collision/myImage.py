...
class MyImage:
    ...
    # Set the initial location using the moveImageToLocation method
    def setLocation(self, newRect):
        self.moveImageToPosition((newRect[0] - self.rect.w/2, newRect[1] - self.rect.h/2))
